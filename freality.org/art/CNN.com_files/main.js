...
function CNN_roofBar( tableCellRef, hoverFlag ) {
	if ( hoverFlag ) {
		tableCellRef.style.backgroundImage = 'url("https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.0/main/roofbar_bg2.gif")';
		if ( document.getElementsByTagName ) {
			tableCellRef.getElementsByTagName( 'a' )[0].style.color = '#c00';
		}
	} else {
		tableCellRef.style.backgroundImage = 'url("https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.0/main/roofbar_bg.gif")';
		if ( document.getElementsByTagName ) {
...
function CNN_validateSearchForm( theForm )
{
	...
	switch ( site.toLowerCase() ) {
		case "web":
		case "google":
			theForm.action = ( location.hostname.indexOf( 'edition' ) != -1 ) ? "https://web.archive.org/web/20041102110929/http://websearch.edition.cnn.com/search/search" : "https://web.archive.org/web/20041102110929/http://websearch.cnn.com/search/search";
		...
		case "cnnasiaweb":
		case "cnneuropeweb":
			theForm.action = "https://web.archive.org/web/20041102110929/http://search.netscape.com/nscp_results.adp";
			theForm.query.value = queryString;
			return true;
		
		case "cnn":
			theForm.action = "https://web.archive.org/web/20041102110929/http://search.cnn.com/cnn/search";
			theForm.query.value = queryString;
			return true;
			
		case "edition":
			theForm.action = "https://web.archive.org/web/20041102110929/http://search.edition.cnn.com/pages/search/advanced.jsp";
			return true;	
		
		case "cnnasia":
			theForm.action = "https://web.archive.org/web/20041102110929/http://search.cnn.com/asia/search";
			theForm.query.value = queryString;
		...
		case "cnneuropeswz":
		case "cnneuropeuk":
			theForm.action = "https://web.archive.org/web/20041102110929/http://search.cnn.com/europe/search";
			theForm.query.value = queryString;
			theForm.source.value = 'cnn';
			return true;
		
		case "cnnsi":
			theForm.action = "https://web.archive.org/web/20041102110929/http://search.si.cnn.com/si/search";
			theForm.query.value = queryString;
		...
		case "cnnfn":
		case "cnnmoney":
			theForm.action = "https://web.archive.org/web/20041102110929/http://search.money.cnn.com/money/search";
			theForm.query.value = queryString;
			theForm.source.value = 'money';
			return true;
		
		case "time":
			theForm.action = "https://web.archive.org/web/20041102110929/http://www.pathfinder.com/time/daily/searchresults/1,2645,,00.html";
			theForm.keyword.value = queryString;
			theForm.col.value = 'time';
			return true;
		
		case "cnnfyi":
			theForm.action = "https://web.archive.org/web/20041102110929/http://websearch.cnn.com/search/snsearch";
...
function email()
{
	...
	location='https://web.archive.org/web/20041102110929/http://www.cnn.com/EMAIL/index.html?'+address;
}

function asiaEmail()
{
	address=document.emailform.emailinput.value;
	location='https://web.archive.org/web/20041102110929/http://asia.cnn.com/EMAIL/asia.index.html?'+address;
}

function euroEmail()
{
	address=document.emailform.emailinput.value;
	location='https://web.archive.org/web/20041102110929/http://europe.cnn.com/EMAIL/europe_index.html?'+address;
}

function italiaEmail()
{
	address=document.emailform.emailinput.value;
	location='https://web.archive.org/web/20041102110929/http://www.cnnitalia.it/EMAIL/index.html?'+address;
}
...
function splitWindow(s) 
{
	...
	var f="https://web.archive.org/web/20041102110929/http://cnn.com/event.ng/Type=click&RunID=17006&ProfileID=749&AdID=11567&GroupID=313&FamilyID=2433&TagValues=4.8.435.487.1098&Redirect=http:%2F%2Fwww.itn.net%2Fcgi%2Fget%3Fjava%2FFlightTicker%2FsplitWindow.html&Stamp="+s;
...
function LV_getVideoUrl( videoUrlPath, format, realOneStatus ) {
	...
	var premiumUrlPrefix = "https://web.archive.org/web/20041102110929/http://premium.cnn.com/pr/video";
	...
	switch( realOneStatus ) {
		...
		default:
			...
			if ( format == "public" ) {
				fullUrl = "https://web.archive.org/web/20041102110929/http://premium.cnn.com/video" + videoUrlPath + "exclude.html";
			}
			break;
	}
...
function displayHat()
{
	...
	{
		case "netscape":
			document.write( '<a href="https://web.archive.org/web/20041102110929/http://www.netscape.com/" target="new"><img src="https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.1/nshat' + imageDir + 'ns.logo.gif" width="95" height="27" hspace="0" vspace="0" border="0"><\/a><a href="https://web.archive.org/web/20041102110929/http://www.netscape.com/" target="new"><img src="https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.1/nshat' + imageDir + 'ns.home.gif" width="53" height="27" hspace="0" vspace="0" border="0"><\/a><a href="https://web.archive.org/web/20041102110929/http://cnn.netscape.cnn.com/news/default.jsp" target="new"><img src="https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.1/nshat' + imageDir + 'ns.news.gif" width="51" height="27" hspace="0" vspace="0" border="0"><\/a><a href="https://web.archive.org/web/20041102110929/http://sportsillustrated.netscape.cnn.com/" target="new"><img src="https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.1/nshat' + imageDir + 'ns.sports.gif" width="61" height="27" hspace="0" vspace="0" border="0"><\/a><a href="https://web.archive.org/web/20041102110929/http://channels.netscape.com/ns/pf/default.jsp" target="new"><img src="https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.1/nshat' + imageDir + 'ns.money.gif" width="63" height="27" hspace="0" vspace="0" border="0"><\/a>' );
			break;
		default:
			document.write( '<a href="https://web.archive.org/web/20041102110929/http://www.netscape.com/" target="new"><img src="https://web.archive.org/web/20041102110929/http://i.cnn.net/cnn/.element/img/1.1/nshat' + imageDir + 'ns.logo.standalone.gif" width="91" height="27" hspace="2" vspace="0" border="0"><\/a>' );
			break;
	}
}
...
/*
     FILE ARCHIVED ON 11:09:29 Nov 02, 2004 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:38:01 Mar 01, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 4563.305 (3)
  esindex: 0.007
  captures_list: 5808.67
  CDXLines.iter: 19.798 (3)
  PetaboxLoader3.datanode: 4200.844 (6)
  exclusion.robots: 0.164
  exclusion.robots.policy: 0.136
  RedisCDXSource: 1131.671
  PetaboxLoader3.resolve: 2468.568 (2)
  load_resource: 2119.497
*/